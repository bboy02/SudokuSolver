...
def rules_checker(Row, Column, Num):
    ...
    #Is the Num appearing in the given grid?
    x0 = (Column // 3) * 3
    y0 = (Row // 3) * 3
    for i in range(0,3):
        for j in range(0,3):
...
def solution():
        ...
        for Column in range(0,9):
            if sudoku_puzzle[Row][Column] == 0:
                for Num in range(1,10):
                    if rules_checker(Row, Column, Num):
    ...
    input('For More possible solutions please click Enter')
